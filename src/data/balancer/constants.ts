...
export const BALANCER_SUBGRAPH_URL_STELLATE = process.env.REACT_APP_SUBGRAPH_URL_STELLATE || '';
export const BALANCER_SUBGRAPH_OP_URL_STELLATE = process.env.REACT_APP_OP_SUBGRAPH_URL_STELLATE || '';
