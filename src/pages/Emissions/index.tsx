...
import { getBeetsTokenAddress } from '../../data/balancer/useLatestPrices';
...
export default function Emissions() {
    ...
    const balAddress = getBeetsTokenAddress(activeNetwork.id);
    //Data
    ...
    return (
        ...
        >
            <Grid
                    ...
                    >
                        <Typography variant='h5'>
                            Under construction for {activeNetwork.name}
                        </Typography>
                    </Grid>
        </Grid>}
        </Box>
